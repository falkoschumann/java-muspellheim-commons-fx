...
import de.muspellheim.commons.fx.control.decoration.*;
 ...
 * <p>
 * <img src="doc-files/hint-validation-decoration.png" alt="Hint validation decoration example">
 */
public class HintValidationDecoration extends AbstractValidationDecoration {

    private static final Image REQUIRED_IMAGE = new Image(GraphicValidationDecoration.class.getResource(
        "/impl/org/controlsfx/control/validation/required-indicator.png").toExternalForm()
    );
    ...
    protected Collection<Decoration> createRequiredDecorations(Control target) {
        return Collections.singletonList(new GraphicDecoration(
